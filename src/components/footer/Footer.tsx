  ...
  return (
    <footer className="md:-mt-9 -mt-5 z-30 relative 2xl:mx-auto 2xl:max-w-7xl">
      ...
      <div className="2xl:mx-auto 2xl:mx-w-7xl bg-gradient-to-b -mt-2 from-zwilt-dark-300 to-zwilt-dark-400 px-10 pt-10   ">
        ...
        >
          <p className="text-white px-4  md:px-0 font-switzerRegular mt-8 md:mt-0 md:max-w-[380px] lg:max-w-[683px] text-2xl lg:text-5xl font-semibold text-center mb-9">
        ...
        <div>
          <div className="mt-24 lg:mt-36 flex flex-col lg:flex-row justify-between gap-10 lg:gap-20">
            ...
            <div className="flex-1">
              <p className="text-white font-switzerBold text-3xl md:text-[54px]  md:leading-[64px] md:text-5xl font-semibold mb-16">
